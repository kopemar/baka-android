...
class EmployeeFragment: ViewModelFragment<EmployeeViewModel, FragmentEmployeeBinding>(R.layout.fragment_employee, EmployeeViewModel::class) {
    ...
    private val employeeInfoFragment by lazy { EmployeeInformationFragment() }
